...
const doc = new Document({
  ...
  sections:[{
    ...
    children:[
      ...
      H1("7. Hazard maps"),
      P("The 100-year event, baseline then scheme — depth first, then the resulting damage. The full set (all return periods, both conditions) accompanies this report."),
      ...img(MAPS+"/depth_100yr_baseline.png", 560, 396, "Figure 4. Flood depth, 100-year — baseline."),
      ...img(MAPS+"/depth_100yr_scheme.png", 560, 396, "Figure 5. Flood depth, 100-year — scheme (dam axis in red, dykes in orange)."),
      ...img(MAPS+"/damage_100yr_baseline.png", 560, 396, "Figure 6. Flood damage, 100-year — baseline."),
      ...img(MAPS+"/damage_100yr_scheme.png", 560, 396, "Figure 7. Flood damage, 100-year — scheme."),
